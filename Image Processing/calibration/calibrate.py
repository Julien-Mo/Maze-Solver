...
for fname in images:
    ...
    if img is None:
        print(f"Could not open or find the image: {fname}")
        continue
...
# Perform calibration if points were found
N_OK = len(objpoints)
if N_OK > 0:
    K = np.zeros((3, 3))
    D = np.zeros((4, 1))
    ...
    print("Calibration failed. No valid checkerboard patterns were found in any images.")
